...
const Journey = () => {
    return (
        <section className="relative bg-[#F4F7FB] dark:bg-[#000616] py-10 md:py-16 overflow-hidden w-full flex flex-col items-center transition-colors duration-500">
            ...
            <div className="relative z-10 w-full flex justify-center items-center py-4 md:py-8 max-w-7xl mx-auto min-h-[250px] md:min-h-[420px]">
                <div className="relative w-[380px] md:w-[380px] h-auto flex justify-center items-center opacity-[0.95]">
                    <Image
                        src="/99.png"
                        alt="99 Brand"
                        width={380}
            ...
            <div className="relative z-30 flex flex-col md:flex-row items-center gap-6 mt-2 w-full justify-center px-10">
                <div className=" px-6 py-3 rounded-[4px] ">
                    <h2 className="text-xl md:text-[32px] font-bold text-black dark:text-white tracking-wide uppercase leading-none">
